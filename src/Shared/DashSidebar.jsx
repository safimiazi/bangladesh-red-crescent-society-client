      ...
      <div>
        <ul className="space-y-2 tracking-wide mt-6  overflow-y-auto ">
            ...
            <NavLink
              ...
              className={({ isActive, isPending }) =>
                isPending
                  ? "pending"
                  : isActive
                  ? " px-5 py-3 flex items-center space-x-4 rounded-lg text-[#FFF] bg-[#006F45]"
                  : ""
              }
            >
              <div className="flex pl-4 mt-5 mb-5 gap-3 items-center">
                <div>
                  <svg
                    width="22"
                    height="22"
                ...
                <h1 className="-mr-1 font-normal text-[16px]   mt-1 text-[#878FA7]">
                  Beneficiaries
                </h1>
              </div>
            </NavLink>
          ...
          <li>
            ...
            >
              <div className="flex pl-4  gap-3 items-center">
                ...
                <h1 className="-mr-1 f text-[16px]  mt-1 text-[#878FA7]">
                  Human Assets
                </h1>
              </div>
            </NavLink>
          ...
          <li>
            ...
            >
              <div className="flex mt-5 pl-4 gap-3 items-center">
                <div>
                  <svg
                    width="17"
                    height="21"
            ...
            >
              <div className="flex mt-4 pl-4 gap-3 items-center">
                <div>
                  ...
                  >
                    <path
                      d="M15.3 7.61043V6.30004C15.3 2.82062 12.4794 0 9 0C5.52058 0 2.7 2.82062 2.7 6.3V7.61038C1.04473 8.45511 0.002025 10.1557 0 12.0141V16.5141C0.00299532 19.2467 2.21742 21.4612 4.94999 21.4641H13.05C15.7826 21.4611 17.997 19.2467 18 16.5141V12.0141C17.998 10.1558 16.9553 8.45511 15.3 7.61043ZM9 2.7C10.9882 2.7 12.6 4.31178 12.6 6.3V7.0641H5.40001V6.3C5.40001 4.31178 7.01179 2.7 9 2.7ZM15.3 16.5141C15.3 17.7567 14.2927 18.7641 13.05 18.7641H4.95004C3.7074 18.7641 2.70005 17.7567 2.70005 16.5141V12.0141C2.70005 10.7715 3.7074 9.76414 4.95004 9.76414H13.05C14.2927 9.76414 15.3 10.7715 15.3 12.0141V16.5141Z"
                      fill="#B1B6CA"
                    />
                    <path
                      d="M8.54995 12.4641H9.44994C10.1955 12.4641 10.7999 13.0685 10.7999 13.8141C10.7999 14.5597 10.1955 15.1641 9.44994 15.1641H8.54995C7.80437 15.1641 7.19995 14.5597 7.19995 13.8141C7.19995 13.0685 7.80437 12.4641 8.54995 12.4641Z"
                      fill="#B1B6CA"
                    />
                  </svg>
                </div>
          ...
          <li>
            ...
            >
              <div className="flex mt-4 pb-8 pl-4 gap-3 items-center">
                <div>
                  <svg
                    width="22"
                    height="22"
