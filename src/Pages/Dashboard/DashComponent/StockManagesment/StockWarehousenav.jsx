...
const StockWarehousenav = () => {
    return (
        <div>
             {/* 1st nav */}
      <div className="flex justify-between items-center  mb-4 lg:flex-row ">
        <div>
        ...
        <div>
          <Link to={'/dashboard/addnewwarehouse'}>
...
export default StockWarehousenav;